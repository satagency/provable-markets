  ...
  <div data-load-wrap class="loader">
    ...
    <div data-load-container class="loader__container">
      ...
      <div class="loader__text-wrap">
        <span data-load-text data-load-reset class="loader__text-el">Loading Aurora</span>
        <span data-load-text data-load-reset class="loader__text-el">Review Complete</span>
      </div>
    </div>
  </div>
</template>
...
onMounted(() => {
  ...
  const initLoader = () => {
    if (typeof window !== 'undefined' && (window as any).gsap) {
      console.log('GSAP loaded, initializing loader...')
...
function initLogoRevealLoader() {
  ...
  console.log('GSAP plugins:', { CustomEase: !!CustomEase, SplitText: !!SplitText })
  ...
  if (!wrap) {
    console.log('Loader wrap element not found')
    return
  }
  ...
  console.log('Elements found:', { container: !!container, bg: !!bg, progressBar: !!progressBar, logo: !!logo, textElements: textElements.length })
  ...
  if (textElements.length >= 2 && SplitText) {
